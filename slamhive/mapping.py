...
roslaunch_command = "roslaunch /slamhive/rgbd.launch " + algo_remap
subprocess.run("bash -c 'source /opt/ros/melodic/setup.bash; \
                ...
                rosnode kill -a ; \
                sleep 5s ; \
                mv /home/ORB_SLAM2/Examples/ROS/ORB_SLAM2/KeyFrameTrajectory.txt /slamhive/result/keyframe.txt; \
                mv /home/ORB_SLAM2/Examples/ROS/ORB_SLAM2/CameraTrajectory.txt /slamhive/result/traj.txt; '", shell=True)
if save_map :
